...
#          end
        ...
        # # IDEE
        # def element_queryset(element)
        #     
        #     if (!element.multiple? && schema.has_foreign_fields?(element.name))
        #         # il get carica le chiavi dell'elemento, l'elemento poi caricherà il resto
        #         return get(element)
        #     else
        #         sub_condition = Condition.or
        #         objects.each do |obj|
        #             condition_row = Condition.and
        #             @model.primary_keys.each do |key|
        #                 condition_row[key.name] = get(key)
        #             end
        #             sub_condition << condition_row
        #         end
        #         return element.model.find(sub_query)
        #     end
        # 
        # end
        # 
